...
result = savings(20,0.5,5)
print("Your savings is " + str(result))
#Example    
...
def material_waste(total_material, material_units, num_jobs, job_consumption):
    ...
    material_wasted = f"{remaining_material}{material_units}"
    return material_wasted

result = material_waste(100,"kg",5, 15)
print("The materials wasted is " + str(result))
#Example  
...
def interest(principal, rate, periods):
    ...
    '''
    quantity = rate * periods + 1 
    simple_interest = principal * quantity
    return simple_interest, periods

result, periods = interest(30, 0.06, 12)
print("The interest after " + str(periods) + " periods invested is " + str(result))
#Example  
...
def body_mass_index(weight, height):
    ...
    weight_kg = weight * pounds_to_kilos
